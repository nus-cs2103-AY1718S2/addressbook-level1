...
public class AddressBook {
    ...
    private enum PersonInfo {NAME, PHONE, EMAIL};
     ...
     */
    private static final ArrayList<HashMap> ALL_PERSONS = new ArrayList<>();
     ...
     */
    private static ArrayList<HashMap> latestPersonListingView = getAllPersonsInAddressBook(); // initial view is of all
    ...
    private static String executeAddPerson(String commandArgs) {
        ...
        final Optional<HashMap> decodeResult = decodePersonFromString(commandArgs);
    ...
    private static String executeFindPersons(String commandArgs) {
        ...
        final ArrayList<HashMap> personsFound = getPersonsWithNameContainingAnyKeyword(keywords);
     ...
     */
    private static String getMessageForPersonsDisplayedSummary(ArrayList<HashMap> personsDisplayed) {
     ...
     */
    private static ArrayList<HashMap> getPersonsWithNameContainingAnyKeyword(Collection<String> keywords) {
        final ArrayList<HashMap> matchedPersons = new ArrayList<>();
    ...
    private static String executeListAllPersonsInAddressBook() {
        ArrayList<HashMap> toBeDisplayed = getAllPersonsInAddressBook();
    ...
    */
     ...
     *
     */
    private static void showToUser(ArrayList<HashMap> persons) {
     ...
     */
    private static String getDisplayString(ArrayList<HashMap> persons) {
     ...
     */
    private static void updateLatestViewedPersonListing(ArrayList<HashMap> newListing) {
     ...
     */
    private static ArrayList<HashMap> loadPersonsFromFile(String filePath) {
        final Optional<ArrayList<HashMap>> successfullyDecoded = decodePersonsFromStrings(getLinesInFile(filePath));
     ...
     */
    private static void savePersonsToFile(ArrayList<HashMap> persons, String filePath) {
     ...
     */
    private static ArrayList<HashMap> getAllPersonsInAddressBook() {
        return ALL_PERSONS;
    }
     ...
     */
    private static void initialiseAddressBookModel(ArrayList<HashMap> persons) {
        ALL_PERSONS.clear();
     ...
     */
    private static String getNameFromPerson(HashMap<PersonInfo, String> person) {
        return person.get(PersonInfo.NAME);
    }
    ...
    private static String getPhoneFromPerson(HashMap person) {
        return (String) person.get(PersonInfo.PHONE);
    }
    ...
    private static String getEmailFromPerson(HashMap person) {
        return (String) person.get(PersonInfo.EMAIL);
    }
     ...
     */
    private static HashMap<PersonInfo, String> makePersonFromData(String name, String phone, String email) {
        final HashMap<PersonInfo, String> person = new HashMap<>();
        person.put(PersonInfo.NAME, name);
        person.put(PersonInfo.EMAIL, email);
        person.put(PersonInfo.PHONE, phone);
        return person;
    }
     ...
     */
    private static ArrayList<String> encodePersonsToStrings(ArrayList<HashMap> persons) {
        final ArrayList<String> encoded = new ArrayList<>();
        for(HashMap h: persons)
            encoded.add(encodePersonToString(h));
        return encoded;
    }
     ...
     */
    private static Optional<HashMap> decodePersonFromString(String encoded) {
        // check that we can extract the parts of a person from the encoded string
        if (!isPersonDataExtractableFrom(encoded)) {
            return Optional.empty();
        }
        final HashMap<PersonInfo, String> decodedPerson = makePersonFromData(
     ...
     */
    private static Optional<ArrayList<HashMap>> decodePersonsFromStrings(ArrayList<String> encodedPersons) {
        final ArrayList<HashMap> decodedPersons = new ArrayList<>();
        for (String encodedPerson : encodedPersons) {
            final Optional<HashMap> decodedPerson = decodePersonFromString(encodedPerson);
     ...
     */
    private static boolean isPersonDataValid(HashMap<PersonInfo, String> person) {
        return isPersonNameValid(person.get(PersonInfo.NAME))
                && isPersonPhoneValid(person.get(PersonInfo.PHONE))
                && isPersonEmailValid(person.get(PersonInfo.EMAIL));
    }
