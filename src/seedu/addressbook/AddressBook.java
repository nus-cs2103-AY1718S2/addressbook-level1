...
public class AddressBook {
    ...
    private static final String COMMAND_SORT_DESC = "Displays all persons sorted by name alphabetically.";
     ...
     * For example, a person's name is stored with the "name" key.
     */
    ...
    private static String executeSortAllPersonsInAddressBook() {
        ArrayList<HashMap<String,String>> toBeDisplayed = sortByName(getAllPersonsInAddressBook());
        showToUser(toBeDisplayed);
        return getMessageForPersonsDisplayedSummary(toBeDisplayed);
    }

    private static ArrayList<HashMap<String,String>> sortByName(ArrayList<HashMap<String,String>> allPersons){
        allPersons.sort((person1,person2) -> person1.get(PERSON_PROPERTY_NAME).compareToIgnoreCase(person2.get(PERSON_PROPERTY_NAME)));
        return  allPersons;
    }
